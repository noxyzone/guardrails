...
- Typos
  `typos.toml`に従います。現在は`.claude/`、`.codex/cache/`、`node_modules/`、`contrib/`、`artifacts/`、`pipedream/html/`配下の生成物・外部由来ファイルを除外します。repo側の暗黙設定ではなく共有`guardrails/typos.toml`を使います。
- Localization
